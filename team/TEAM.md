...
## Current state (2026-09-19 16:40 - PM-verified, don't re-derive)
...
- Reviewer = `codex exec … </dev/null`, run by the PM. Codex has a usage limit: hit 2026-09-17 20:21 (→21:34), 22:30 (→02:35), 2026-09-18 03:53 (→07:38), 10:49 (→12:41), 16:50 (→17:44), then **2026-09-19 16:39 the WEEKLY limit (→ Tue 2026-09-22 12:21)** - #85 (B6 kipp + rule-8 claim) is OPEN and must be re-run first thing after that; no code review is possible before then unless Eddy provides another non-Claude reviewer; ~11-15 reviews per 5-h window; queue them, never two at once. Seats boot in visible Terminal windows with `--remote-control`; nudges need a trailing empty `do script`.
