...
## Current state (2026-09-18 16:47 - PM-verified, don't re-derive)
...
- Reviewer = `codex exec … </dev/null`, run by the PM. Codex has a usage limit: hit 2026-09-17 20:21 (→21:34), 22:30 (→02:35), 2026-09-18 03:53 (→07:38), 10:49 (→**12:41**); ~11-15 reviews per window; queue them, never two at once. Seats boot in visible Terminal windows with `--remote-control`; nudges need a trailing empty `do script`.
